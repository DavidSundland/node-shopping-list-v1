...
Recipes.create('chili', ['red beans', 'chickpeas', 'TVP', 'cayenne pepper', 'diced tomatoes', 'mustard', 'spinach', 'onion', 'garlic', 'cumin']);
Recipes.create('beverage', ['gallon of port', 'gallon of burgundy']);
Recipes.create("chef's surprise", ['this', 'that', 'whatnot']);
